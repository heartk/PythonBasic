...
# Just keep doing these exercises and going through your checklist from the last exercise
# and you will eventually get it.

# there is one tiny point that you might not have realized, which we'll reinforce right now.
# The variables in your function are not connected to the variables in your script. Here's
# an exercise to get you thinking about this:
